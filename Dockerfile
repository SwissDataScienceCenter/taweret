...
RUN /bin/bash -c "curl -L https://github.com/SwissDataScienceCenter/taweret/releases/download/v0.1.0-beta/taweret_0.1.0_Linux_x86_64.tar.gz | tar xvz -C /usr/local/bin/; \
