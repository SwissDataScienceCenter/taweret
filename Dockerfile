...
RUN /bin/bash -c "curl -L https://github.com/SwissDataScienceCenter/taweret/releases/download/v0.2.0-beta6/taweret_0.2.0-beta6_Linux_x86_64.tar.gz | tar xvz -C /usr/local/bin/; \
